...
/**
 * This class represents the Meal of type Dinner in the sql way.(table of  breakfast Dinner)
 * Created by קובי on 14/08/2016.
 */
public class MealDinnerSql {

    final static String MEAL_TABLE = "mealsDinner2";
