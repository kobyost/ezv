...
/**
 * This class is responsible for downloading and uploading images via the Cloudinary cloud database.
 * Created by קובי on 04/08/2016.
 */
public class ModelCloudinary {
    Cloudinary cloudinary;

    public ModelCloudinary() {
        cloudinary = new Cloudinary("cloudinary://691136812728982:ueqE3lSPpwioxF0lSXhYpvAr2lo@koby");
    }
