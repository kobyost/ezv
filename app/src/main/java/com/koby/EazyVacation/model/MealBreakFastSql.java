...
/**
 * This class represents the Meal of type Breakfast in the sql way.(table of  breakfast meals)
 * Created by קובי on 14/08/2016.
 */
public class MealBreakFastSql {

    final static String MEAL_TABLE = "mealsBreakFast1";
